...
# === Runtime environment overrides for Vercel / serverless ===
# You can override these via environment variables without editing the file.
import os as _os
API_KEY = _os.getenv("API_KEY", API_KEY)
XDATA_DECRYPT_URL    = _os.getenv("XDATA_DECRYPT_URL", XDATA_DECRYPT_URL)
XDATA_ENCRYPT_SIGN_URL = _os.getenv("XDATA_ENCRYPT_SIGN_URL", XDATA_ENCRYPT_SIGN_URL)
PAYMENT_SIGN_URL     = _os.getenv("PAYMENT_SIGN_URL", PAYMENT_SIGN_URL)
BOUNTY_SIGN_URL      = _os.getenv("BOUNTY_SIGN_URL", BOUNTY_SIGN_URL)
AX_SIGN_URL          = _os.getenv("AX_SIGN_URL", AX_SIGN_URL)
